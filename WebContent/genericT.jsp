			...
			<section id="post" class="wrapper bg-img" data-bg="banner5.jpg">
				<div class="inner">
					<article class="box">
						...
						<div class="content">
						<a href="CreateT.jsp" class="button alt">Create Your Order</a>
						<a href="ReadT.jsp" class="button alt">Check Your Order</a>
						<a href="UpdateT.jsp" class="button alt">Change Your Order</a>
						<a href="DeleteT.jsp" class="button alt">Delete Your Order</a>
						</div>
						<footer>
							<ul class="actions">
